...
.. image:: ../_static/jellybean_art.png
...
* You can already write :code:`me == j2` -> and get a return value of True or False.   
* Create an implementation that when writing :code:`me == j2` checks if the mass of the 2 objects are alike.
* Create an implementation that when writing :code:`me < j2` checks if the mass of 'me' is less than 'j2'.  
